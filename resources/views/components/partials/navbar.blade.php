<div class="main-header">
    ...
    <div class="logo-header" data-background-color="red2">
        ...
        <a href="index.html" class="logo">
            <img src="{{ asset('assets/img/logo.png') }}" alt="navbar brand" class="navbar-brand" width="110" height="40">
        </a>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            ...
                            <li>
                                ...
                                <form action="{{ route('logout') }}" id="logout-form" method="POST">
                                    @csrf
                                    <a class="dropdown-item" href="javascript:$('#logout-form').submit();">Logout</a>
                                </form>
                            </li>
                        </div>
                    </ul>
